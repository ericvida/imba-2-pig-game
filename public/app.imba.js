...
class GameInfoComponent extends imba.tags.get('component','ImbaElement') {
	render(){
		...
		b$0 || (t$2.target="_blank");
		b$0 || t$1.insert$(" Language. Example borrowed from the ");
